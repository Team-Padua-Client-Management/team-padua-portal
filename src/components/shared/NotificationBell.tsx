...
export default function NotificationBell() {
  ...
  useEffect(() => {
    ...
    // Setup realtime subscription with a unique channel name to prevent Strict Mode collisions
    const channelName = `realtime_notification_bell_${Math.random().toString(36).substring(7)}`;
