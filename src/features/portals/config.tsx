...
export const portalsConfig: PortalListItem[] = [
  ...
  {
    slug: 'client-policy-card',
    name: 'Client Policy Card',
    description: 'Client policy management system and digital insurance policy card access.',
  ...
  {
    slug: 'daniel-padua-portfolio',
    name: 'Daniel Padua Portfolio',
    description: 'Executive portfolio, professional biography, and showcase website.',
