      ...
      <div className={styles.heroGlassCard}>
        ...
        <div className={styles.glassTopBar}>
          <div className={styles.glassDateGroup}>
            <Calendar size={15} className={styles.glassCalendarIcon} />
          ...
          <div className={styles.glassTimeGroup}>
            <Clock size={15} className={styles.glassClockIcon} />
          ...
          >
            {isRefreshing ? <Loader2 size={15} className={styles.spinIcon} /> : <RefreshCw size={15} strokeWidth={2} />}
          </button>
        </div>
