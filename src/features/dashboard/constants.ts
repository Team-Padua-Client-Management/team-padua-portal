...
export const defaultPortals: Portal[] = [
  ...
  { name: 'Canva', logo: '/images/logos/canva.svg', width: 24, url: 'https://www.canva.com/', manage: '/admin/portals/canva' },
  ...
  { name: 'Client Policy Card', logo: '/Image/icon/DP-LOGO.png', width: 24, url: 'https://team-padua-client-policy-card.vercel.app/', manage: '/admin/portals/client-policy-card' },
  { name: 'Daniel Padua Portfolio', logo: '/Image/icon/DP.png', width: 24, url: 'https://danielpadua.vercel.app/', manage: '/admin/portals/daniel-padua-portfolio' },
];
