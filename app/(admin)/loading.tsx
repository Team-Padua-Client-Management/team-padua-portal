 ...
 * loading.tsx
 *
 * Main component module in features path: app/(admin)/loading.tsx
 *
 * Responsibilities:
...
import styles from "@/styles/app/(admin)/loading.module.css";
...
function SunLifeLogo() {
  return (
    <svg className={styles.text_0} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="gold-grad-admin" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <path 
        ...
        fill="url(#gold-grad-admin)" 
      />
      <circle cx="50" cy="50" r="18" fill="url(#gold-grad-admin)" stroke="white" strokeWidth="2" className={styles.table_7} />
    </svg>
  );
}
