      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-4 md:p-6 lg:p-8 space-y-6 overflow-y-auto">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold tracking-tight text-text">Fund Switching Management</h1>
              <p className="text-sm text-text-secondary mt-1">Manage Fund Switching requests.</p>
            </div>
              ...
              <table className="w-full text-left border-collapse text-sm whitespace-nowrap">
                <thead>
                  <tr className="bg-surface-2 border-b border-border">
                    ...
                    <th className="py-2.5 px-3 font-semibold text-text-secondary uppercase text-[10px] tracking-wider">From Fund</th>
                    <th className="py-2.5 px-3 font-semibold text-text-secondary uppercase text-[10px] tracking-wider">To Fund</th>
                ...
                <tbody className="divide-y divide-border">
                  <tr>
                    <td colSpan={7} className="py-12 text-center text-text-secondary text-sm">No records found.</td>
                  </tr>
                </tbody>
              </table>
            </div>
