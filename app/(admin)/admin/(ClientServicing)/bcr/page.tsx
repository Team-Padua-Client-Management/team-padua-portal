...
import { Plus, Search, Edit2, Trash2, Download, Filter, FileText } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-4 md:p-6 lg:p-8 space-y-6 overflow-y-auto">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold tracking-tight text-text">BCR Management</h1>
              <p className="text-sm text-text-secondary mt-1">Manage Beneficiary Change Requests (BCR).</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { label: 'TOTAL REQUESTS', count: 0, color: 'text-text', icon: FileText, isYellowBorder: true },
